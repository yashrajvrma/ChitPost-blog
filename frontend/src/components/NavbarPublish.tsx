  ...
  return (
    <div className="flex flex-row justify-between sm:px-10 px-4 h-20  text-slate-100 font-sans tracking-tight border-b-2 border-slate-100">
      ...
      <div className="flex flex-row justify-center items-center gap-5">
        <div className="flex justify-center items-center text-slate-100 font-semibold text-lg bg-green-500 w-32 h-10 mb-2 rounded-full cursor-pointer">
          <div>Publish</div>
        </div>
        <div>
          <Popover>
            <PopoverTrigger>
              <img
                ...
                className="profile-picture w-10 sm:w-12 rounded-full"
              />
            </PopoverTrigger>
